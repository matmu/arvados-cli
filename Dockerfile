...
RUN apt-get update && apt-get -y --no-install-recommends install ruby-full bundler build-essential libcurl4-openssl-dev apt-utils gnupg wget dirmngr curl bzip2 git && apt-get clean && ruby --version
