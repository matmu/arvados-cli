...
RUN apt-get update && apt-get -y --no-install-recommends install ruby ruby-dev bundler build-essential libcurl4-openssl-dev gnupg wget dirmngr && apt-get clean
